...
Nonlinear Programming (NLP) Optimal Power Flow solver with discrete variables approximated from continuous values
from tap changers and shunt elements
...
from numpy import zeros, pi, round
